...
from libs.aws.dns_mapping import get_hostedzone, create_hostedzone, get_ns_from_hostedzone, \
    check_ns_values, fill_dns_dict
...
class ClusterRules(object):
    ...
    def fill_hostedzone(self, services_by_name):
        ...
        sub_dns_id = get_hostedzone(self._boto, self.sub_dns) or \
            create_hostedzone(self._boto, self.sub_dns)
