...
RUN curl -fsSL https://raw.githubusercontent.com/ahmetb/kubectl-aliases/master/.kubectl_aliases -o /etc/profile.d/.kubectl_aliases && \
    chmod +x /etc/profile.d/.kubectl_aliases
